...
class ResNet3D(nn.Module):
    def __init__(self, output_len=100,in_channels=1, out_channels=32, device=None, **kwargs):
        ...
        nc = 64
        self.c1 = nn.Conv3d(in_channels=in_channels, out_channels=nc, kernel_size=5, stride=1, padding=2)
        self.c2 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
        self.c3 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
        #self.d4 = nn.Conv1d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1)
        self.c4 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
        self.c41 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
        self.c42 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
        self.c43 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
        self.c44 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
        self.c45 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
        self.c46 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
        self.c47 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
        self.c48 = nn.Conv3d(in_channels=nc, out_channels=nc, kernel_size=5, stride=1, padding=2)
