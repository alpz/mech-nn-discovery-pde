...
class Model(nn.Module):
    ...
    def solve(self, u, v, up, vp, uvp, params_list, t_params, steps_list):
        ...
        rhs_u = (params_list[3][0]*vp + params_list[3][1]*A2*vp) #+ (1*params_list[0][0]+ params_list[0][1]*A2)*up
...
def optimize(nepoch=5000):
    ...
    for epoch in range(nepoch):
        ...
        #for i, batch_in in enumerate((train_loader)):
            ...
            var_uv_loss = (var_uv- batch_uv).abs().mean(dim=-1)
