...
class EulerDataset(Dataset):
    ...
    def generate(self):
        def f(state, t):
            ...
            n =  0.5 + 2*x + 0.8*x**2
            d =  1 + 0.1*t + 0.2*t**2
            #n = 0.0087+  0.0617*x+  0.0455*x**2 
            #d = -0.4399+ -0.1430*t + -0.1311*t**2
            #n = 0.1467+  0.4373*x + -0.2763*x**2  
            #d = 0.2790+  0.2348*t+  0.2574*t**2
            n = 0.2203+  0.6655*x + -0.3009*x**2
            d = 0.3436+  0.1813*t +  0.1814*t**2

            #n = 0.0168 +  0.0761*x  + 0.0349*x**2 
            #d = -0.5964+ -0.3271*t + -0.2639*t**2

            #n = -0.0100 + -0.0338*x +  0.0104*x**2 
            #d = -0.3966 +  -0.1610*t +  -0.1239*t**2
