...
def QPFunction(pde, n_iv, gamma=1, alpha=1, double_ret=True):
    class QPFunctionFn(Function):
        ...
        def backward(ctx, dl_dzhat):
            ...
            dq = dnu2
            #nr, nrr = mg.get_residual_norm(AtA,dnu, dl_dzhat)
